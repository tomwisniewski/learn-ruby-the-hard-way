...
puts Ex25.puts_first_word(words)
puts Ex25.puts_last_word(words)
puts Ex25.puts_first_word(sorted_words)
puts Ex25.puts_last_word(sorted_words)
sorted_words = Ex25.sort_sentence(sentence)
puts Ex25.sort_words(words)

puts Ex25.puts_first_and_last(sentence)

puts Ex25.puts_first_and_last_sorted(sentence)
